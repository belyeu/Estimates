...
Basic Angular seed application created with Quick start application (Tour of Contacts) given on angular website. It uses ExpressJS along with Mongo DB support (Mongoose) via a wrapper of Repository Pattern as Business layer.
It also uses Gulp for running task and TsLint.The seed application is built over node and uses latest node packages.

## [https://angular2-express-mongoose.contactkuapp.com/](https://angular2-express-mongoose.contactkuapp.com/)
...
angular2-MEAN
    ...
    │    │    │    ├── contact.ts
    │    │    ├── services
    │    │    │    ├── contact.service.ts            <= Contact Service for fetching api
    │    │    ├── app.component.css
    │    │    ├── app.component.ts
    │    │    ├── app.html
    │    │    ├── app.module.ts
    ...
    │    │    │    ├── dataAccess
    │    │    │    │    ├── schemas
    │    │    │    │    │    ├── ContactSchema.ts    <= Contact Schema for MongoDB
    ...
    │    │    │    ├── routes
    │    │    │    │    ├── ContactRoutes.ts        <= Contact API Routes like get,post,put,delete
...
1.  Angular 2 Quick Start application (Tours of Contact) from https://angular.io/docs/ts/latest/quickstart.html
...
9.  Added MongoDB support to communicate our Contacts data to Database
10. Implemented Repository Pattern to communicate with Mongoose.

## Api Document (from MongoDB)

```
1. getAll    http://localhost:3000/api/Contacts             <= get all Contacts
1. getById   http://localhost:3000/api/Contacts/:id         <= get contact by Id
2. post      http://localhost:3000/api/Contacts             <= create contact
2. put       http://localhost:3000/api/Contacts/:id         <= update contact
2. delete    http://localhost:3000/api/Contacts/:id         <= delete contact
